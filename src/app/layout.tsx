...
const DESCRIPTION =
  "한국인을 위한 미국 세금 신고 완벽 가이드. F-1 유학생, J-1 연구원/교환학생, H-1B 취업비자, 동반비자(F-2/J-2/H-4), 영주권자(Green Card), 시민권자 대상. SPT 거주자 판정부터 한미 조세조약, Form 1040/1040-NR, Form 8843, FBAR, FATCA, FTC/FEIE, Sprintax 사용법, 연방세·주세 신고, 환급 추적까지 8단계로 안내합니다.";
...
const jsonLdWebPage = {
  ...
  audience: {
    "@type": "Audience",
    audienceType: "한국인 미국 거주자, 유학생, 취업비자 소지자, 영주권자, 시민권자",
  },
  mainEntity: {
    "@type": "HowTo",
    ...
    step: [
      {
        ...
        position: 1,
        name: "시작하기",
        text: "본인의 비자 유형(F-1, J-1, H-1B, 동반비자) 또는 신분(영주권자, 시민권자)을 선택합니다.",
      },
      {
        "@type": "HowToStep",
        position: 2,
